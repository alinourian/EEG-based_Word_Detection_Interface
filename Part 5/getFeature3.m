function new_Subject = getFeature3(Subject,mode,N)
    if mode == 1
        new_Subject = Subject;
    end
    ...
    temp = new_Subject.target_feature;
    feature = temp;
    for i=1:N-1
        feature = cat(1,feature,temp); 
    end
    feature = cat(1,feature,new_Subject.not_target_feature); 
